...
If another delivery mechanism is separately approved in the future, it must preserve this authority boundary and must not become an alternate source of product, installer, documentation, or release truth. This decision does not require another delivery mechanism now.
